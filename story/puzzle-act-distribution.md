...
Players are encountering the temple for the first time. No glyph literacy needed to start. B (Glyph Cipher) introduces the central glyph system — players begin learning letter mappings here.

| Slot | Puzzle Type | Why Act 1 |
|------|-------------|-----------|
...
Players have full glyph literacy. Puzzles require mastery and synthesis of everything learned.

| Slot | Puzzle Type | Why Act 3 |
|------|-------------|-----------|
| 1 | **K** — Reverse Decipherment | Encode English back into glyphs — reverse of everything they've done |
| 2 | **L** — Temporal Glyphs | The "aha" realization that glyphs describe time — climactic |
| 3 | **E** — Grid Phrasal Reconstruction | Coordinates + glyphs — layered, requires strong glyph literacy |
| 4 | **I** — Symbol Word Search | Find and trace connected symbols — synthesis |

## The Player Arc

- **Act 1:** "What are these symbols?" — discovery, first decoding, building familiarity
- **Act 2:** "I can read these, but they're fighting back" — deeper decoding, corruption, the language resists
- **Act 3:** "I understand this language well enough to write in it and see what it's hiding" — mastery, reversal, temporal truth
