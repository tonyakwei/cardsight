# Drake Delegation — Act 1 Story Card
...
Set into the far wall — a heavy stone wheel, seized with age. Channels radiate from it across the floor. Your tactical eyes read it immediately: this controls the water flow. Five glyphs are carved into the wheel's face — the unlock command. Inscribed stone Wheel Fragments lie scattered at the base, though the other teams have grabbed a few. You could liberate those back...

**3. Reach the Shadow Astrolabe**
At the center of the chamber — a stone table, and on it, a thick glass dome. Through the glass: a strange contraption with golden concentric rings, nested inside each other, etched with markings so fine they shimmer. Sealed under glass you cannot safely break without possibly destroying the object. The base has five empty slots, each with a dial of colors — a combination lock. It seems the other teams may have the Strange Discs needed to open the dome. You could go liberate those from them...

**4. Activate the Construction Hoist**
Directly overhead, near the center of the chamber — thick iron chains hang from the dark above, taut and corroded green, dropping to a stone slab pulled tight against the floor. Nine positions on the chains and pulleys are marked with QRian glyphs — clearly an activation sequence. Fallen chain links with Hoist Markings are scattered across the chamber, though the other teams have been pocketing them. You could liberate those back...

**5. Investigate the Scraped Gap**
Along the back wall, half-hidden behind a collapsed pillar — a dark crack in the stone scored with bright metal scratches. A faint breeze from inside that smells like old dust and old fear. Waterlogged pages — Journal Fragments — lie scattered near the gap, though the other teams have already grabbed a few. You've squeezed through worse for less money...
